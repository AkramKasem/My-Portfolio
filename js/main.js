...
function chooseFont(selectedFont) {
  ...
  localStorage.setItem("akram-font", selectedFont.getAttribute('data-size'));
}
...
let storageFont = localStorage.getItem("akram-font");
...
/*==================  Change Main color =======================*/
let storageColor = localStorage.getItem("akram-color");
...
function getMainColor(selectedColor, colorValue) {
  ...
  localStorage.setItem("akram-color", colorValue);
}
...
/* =============== Change Theme Mode  ==================*/
let darkMode = localStorage.getItem('akram-theme');
...
function enableDarkMode() {
  localStorage.setItem('akram-theme', 'dark');
  body.classList.add("dark");
  removeThemeSelector();
  Bg3.classList.add("active");
}
function disableDarkMode() {
  localStorage.setItem('akram-theme', 'light');
  body.classList.remove("dark");
  removeThemeSelector();
  Bg1.classList.add("active");
}
function deviceThemeMode() {
  localStorage.setItem('akram-theme', 'dim');
